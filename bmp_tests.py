...
class TestMetadataExtractor(unittest.TestCase):
    ...
    def test_bitmap_file_size(self):
        ...
        self.assertEqual(get_bitmap_info_dict(get_headers("test-images/debugging.bmp"))['file size'], '485.42 KB')
    ...
    def test_bitmap_width_and_height(self):
        ...
        self.assertEqual(get_bitmap_info_dict(get_headers("test-images/debugging.bmp"))['width'], 471)
        ...
        self.assertEqual(get_bitmap_info_dict(get_headers("test-images/debugging.bmp"))['height'], 351)
    ...
    def test_bitmap_color_depth(self):
        ...
        self.assertEqual(get_bitmap_info_dict(get_headers("test-images/debugging.bmp"))['color depth'], 24)
    ...
    def test_bitmap_number_of_panels(self):
        ...
        self.assertEqual(get_bitmap_info_dict(get_headers("test-images/debugging.bmp"))['number of panels'], 1)
    ...
    def test_bitmap_num_colors(self):
        ...
        self.assertEqual(get_bitmap_info_dict(get_headers("test-images/debugging.bmp"))['num colors'], "unindexed")
    ...
    def test_bitmap_created_time(self):
        ...
        self.assertEqual(get_all_bmp_metadata("test-images/debugging.bmp")['created'], 'Fri Apr 14 23:33:29 2017')
    ...
    def test_bitmap_header_field(self):
        ...
        self.assertEqual(get_all_bmp_metadata("test-images/debugging.bmp")['header field'], 'BM')
    ...
    def test_bitmap_bitmap_info_size(self):
        ...
        self.assertEqual(get_all_bmp_metadata("test-images/debugging.bmp")['bitmap info size'], 40)
